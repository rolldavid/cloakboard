 ...
 *
 * Format: {Adjective}{Noun} — max 19 chars, fits in 31 bytes (FieldCompressedString).
 */
 ...
 * Uses a simple hash to pick adjective and noun.
 */
...
/** Simple deterministic hash: returns 2 numbers from a string seed. */
