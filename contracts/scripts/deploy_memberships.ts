/**
 * Deploy CloakMemberships Contract
 *
 * Deploys the public membership tracking contract to the Aztec network.
 * This contract stores which users are members of which cloaks.
 *
 ...
 *
 * Usage:
 *   npx ts-node scripts/deploy_memberships.ts
 */
...
async function main() {
  ...
  console.log("CloakMemberships Deployment");
  console.log("=".repeat(60));
  console.log("");
  ...
  console.log("\nLoading CloakMemberships artifact...");
  const artifactModule = await import('../target/cloak_memberships-CloakMemberships.json', { with: { type: 'json' } });
  ...
  console.log("\nStep 2: Deploying CloakMemberships instance...");
  ...
  try {
    ...
    console.log("=".repeat(60));
    console.log("");
    console.log(`CloakMemberships Address: ${contractAddress}`);
    console.log("");
    console.log("Add to app/.env.local:");
    console.log(`   NEXT_PUBLIC_CLOAK_MEMBERSHIPS_ADDRESS=${contractAddress}`);
    console.log("");
    ...
    try {
      ...
      console.log(`\nCloakMemberships deployed at: ${expectedAddress.toString()}`);
      console.log("DEPLOYMENT SUCCESSFUL (verified on-chain)!");
      console.log(`NEXT_PUBLIC_CLOAK_MEMBERSHIPS_ADDRESS=${expectedAddress.toString()}`);
